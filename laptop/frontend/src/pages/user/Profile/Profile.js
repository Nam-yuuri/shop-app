                                        ...
                                        <div className={cx('content-price')}>
                                            <div className={cx('discount-price')}>
                                                {formatPrice(
                                                    parseFloat(
                                                        products.cost -
                                                            ((products.cost * products.promotional) / 100).toFixed(0),
                                                    ),
                                                )}
                                            </div>
                                        ...
                                        <div className={cx('box-gift')}>
                                            <div>
                                                <div className={cx('box-gift-content')}>
                                                    ...
                                                    <span className={cx('gift-num')}>x{products.gift_image_count}</span>
                                        ...
                                        <span>
                                            ...
                                            <li>
                                                <span>
                                                    ...
                                                    <span className={cx('list-price')}>100.000đ</span> khi thanh toán
                                                    qua VNPAY-QR.
                                                </span>
                                                <a href=" " className={cx('list-href')}>
                                                    Xem chi tiết
                                            ...
                                            <li>
                                                <span>
                                                    ...
                                                    <span className={cx('list-price')}>1.000.000đ</span> khi thanh toán
                                                    qua VNPAY-QR.
                                                </span>
                                                <a href=" " className={cx('list-href')}>
                                                    Xem chi tiết
